...
<body class="overflow-x-hidden">
    <div class="sm:block hidden">
        <header class="text-gray-600 body-font bg-blue-800">
            <div
                class="container mx-auto flex flex-wrap justify-between p-5 px-40 flex-col md:flex-row items-center hidde">
                <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round"
                        stroke-linejoin="round" stroke-width="2"
                        class="w-10 h-10 text-white p-2 bg-green-500 rounded-full" viewBox="0 0 24 24">
                        ...
                        <div class="space-y-8">
                            <div class="space-y-4">
                                ...
                                <p class="text-base text-gray-200 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                                    Prioritize your mental well-being with our online mental checkup website. Take the
                                    first
    ...
    <div class="block sm:hidden">
        <div class="py-5 text-xl w-full px-5 shadow-sm">
            MentalCheckup
        </div>
        <div class="bg-gray-200 h-screen w-full text-center pt-20">
            <h1 class="text-2xl">Take a mental Test Now</h1>
            <a href="/disorder/types">

                <button type="button"
                    class="text-white mt-5 bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-md text-sm px-10 py-2.5 text-center mr-2 mb-2">
                    Take a Test
                </button>
            </a>
        </div>
