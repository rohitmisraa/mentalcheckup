...
<body class="p-0 m-0 bg-[#d3fab1]">
    ...
    <section class="text-gray-600 body-font">
        ...
        <div class="container py-10 mx-auto flex flex-wrap flex-col">
            <div class="w-max mx-auto p-10 shadow-md bg-white">

            
            <h1 class="text-center text-2xl mb-20">ADHD Test</h1>
            <div id="qnlist" class="flex mx-auto flex-wrap mb-10 hiddsen border">
                <a
    ...
    {{-- <input type="hidden" name="ques_data" id="ques_data" value="{{$questions['questions']}}"> --}}
    ...
    <script>
        ...
        // var questions = JSON.parse(data.replace(/&quot;/g,'"'));
